namespace Greens_Garage
{
	partial class DataModule
	{
		...
		private void InitializeComponent()
		{
			...
			this.dsGreen = new Greens_Garage.DSGreen();
    ...
    "mentID";
			...
			// ctnGreen
			// 
			this.ctnGreen.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Temp\\Green.mdb";
			// 
			// oleDbInsertCommand1
			// 
    ...
    ", ?)";
			...
			// dsGreen
			// 
			this.dsGreen.DataSetName = "DSGreen";
